...
class Persona
{
	...
	public static function TraerTodasLasPersonas(){     
		$sql = "SELECT CONCAT(Nombre, ' ', Apellido) as nomap ,idUsuario FROM `usuarios`
        where estado=true
                order by nomap asc";
    ...
    public static function InsertarPersona($email,$password,$rol,$nombre,$apellido,$dni,$legajo){

        $sql = 'INSERT INTO usuarios (idrol,email,password,nombre,apellido) VALUES (:rol, :email,:password,:nombre,:apellido)';
			$consulta = AccesoDatos::ObtenerObjetoAccesoDatos()->ObtenerConsulta($sql);
    ...
    public static function ModificarPersona($email,$password,$rol,$nombre,$apellido,$dni,$legajo,$id){
